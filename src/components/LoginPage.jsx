        ...
        <div className={s.card}>
          ...
          <div className={s.leftPanel}>
            ...
            <div className={s.leftContent}>
              <span className={s.securityTag}>Security First</span>
              <h2 className={s.leftHeading}>
                Precision in<br />
            ...
            <form onSubmit={handleLogin}>
              <div className={s.fieldGroup}>
                ...
                <div className={shared.inputWrap}>
                  ...
                  />
                  <span className={shared.inputIcon}><AtIcon /></span>
                </div>
              </div>

              <div className={s.fieldGroup}>
                <div className={s.forgotRow}>
                  <label className={shared.label} style={{ margin: 0 }}>Security Key</label>
                ...
                <div className={shared.inputWrap}>
                  ...
                  <span className={shared.inputIcon} onClick={() => setShowPassword(v => !v)}>
                    {showPassword ? <EyeIcon open /> : <LockIcon />}
                  </span>
                </div>
              </div>
              ...
              >
                {status === 'loading' ? 'Signing in...' : 'Sign into AkountSmart →'}
              </button>
            </form>

            <div className={s.divider}>OR</div>

            <button className={s.googleBtn} onClick={handleGoogleLogin} type="button">
              <GoogleIcon />
